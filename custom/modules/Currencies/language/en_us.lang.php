...
$mod_strings = array(
    ...
    'LBL_ADDITINAL_CURSE' => 'Additional kurse, %',
    'LBL_ADDITINAL_CURSE_DESC' => 'The specified % will be added to the hryvnia exchange rate in relation to other currencies when updating',
);
