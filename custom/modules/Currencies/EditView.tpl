...
{sugar_help text=$MOD.LBL_LIST_RATE_HELP }
                ...
                <tr>
                    ...
                    {if $CURRENCY_ISO4217 == "UAH"}
                        <td scope="row"><span>{$MOD.LBL_ADDITINAL_CURSE}:</span></td>
                        <td>
                            <span><input name='percent' tabindex='1' size='3' maxlength='50' type="text" value="{$PERCENT}"></span>
                            <span style="display: block">{$MOD.LBL_ADDITINAL_CURSE_DESC}</span>
                        </td>
                    {/if}
                </tr>
            </table>
